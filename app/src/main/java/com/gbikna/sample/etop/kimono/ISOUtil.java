...
public class ISOUtil {
	private static final String TAG = ISOUtil.class.getSimpleName();
	public static final int[] tlvTags = new int[]{
			40742, // 9F26
			40743, // 9F27
			40720, // 9F10
			40759, // 9F37
	 ...
	 * @return an array of length = the smallest between op1 and op2
	 */
	public static byte[] xorAnd(byte[] op1, byte[] op2) {
		byte[] result;
		// Use the smallest array
		int length;
		if (op2.length > op1.length) {
	 ...
	 * @return an array of length = the smallest between op1 and op2
	 */
	public static byte[] xorOr(byte[] op1, byte[] op2) {
		byte[] result;
		// Use the smallest array
		int length;
		if (op2.length > op1.length) {
	 ...
	 * @return an array of length = the smallest between op1 and op2
	 */
	public static String hexXor(String op1, String op2) {
	 ...
	 * @return an array of length = the smallest between op1 and op2
	 */
	public static String hexAnd(String op1, String op2) {
		byte[] result = xorAnd(hex2byte(op1), hex2byte(op2));
	...
	public static String hexOr(String op1, String op2) {
		byte[] result = xorOr(hex2byte(op1), hex2byte(op2));
		return hexString(result);
	}
	...
	public static String hideString(String s, int from, int to)
	{
		StringBuilder ns = new StringBuilder();
		ns.append(s.substring(0, from));

		for (int i = from; i < to; i++) {
			ns.append("_");
		}

		ns.append(s.substring(to));
	...
	public static String maskPan(String pan)
	{
		...
		StringBuilder ns = new StringBuilder();
		ns.append(pan.substring(0, from));

		for (int i = from; i < to; i++) {
			ns.append("*");
		}

		ns.append(pan.substring(to));
