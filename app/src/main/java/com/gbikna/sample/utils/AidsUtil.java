...
public class AidsUtil {
    ...
    private static List<AidEntity> loadAID()
    {
        List<AidEntity> aidEntityList = new ArrayList<>();

        AidEntity aid = AidEntity.builder()
                .AID("A0000000041010")
                .selFlag(0)
                .appVersion("0001")
                .DDOL("9F3704")
                ...
                .threshold(100)
                .build();
        aidEntityList.add(aid);

        aid = AidEntity.builder()
                .AID("A0000000044010")
                .selFlag(0)
                .appVersion("0001")
                .DDOL("9F3704")
    ...
    public static List<CapkEntity> loadCAPK()
    {
        List<CapkEntity> capkEntityList = new ArrayList<>();

        // capk for MASTERCARD
        CapkEntity capk = CapkEntity.builder()
                .RID("A000000004")
                .capkIndex(0x05)
                .arithInd(0x01)
                .hashInd(0x01)
                ...
                .build();
        capkEntityList.add(capk);

        capk = CapkEntity.builder()
                .RID("A000000004")
                .capkIndex(0xf1)
                .arithInd(0x01)
                .hashInd(0x01)
