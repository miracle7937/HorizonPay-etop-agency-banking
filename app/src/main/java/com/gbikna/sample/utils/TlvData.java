...
//        AppLog.d(TAG,"getDataLength: data: "+HexUtil.bytesToHexString(data));
//        AppLog.d(TAG,"getDataLength: offset: "+offset);
//        AppLog.d(TAG,"getDataLength: tLen: "+tLen);
//        AppLog.d(TAG,"getDataLength: lLen: "+lLen);
