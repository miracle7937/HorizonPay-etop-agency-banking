...
public class PrintActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public PrintActivity_ViewBinding(PrintActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public PrintActivity_ViewBinding(final PrintActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    PrintActivity target = this.target;
