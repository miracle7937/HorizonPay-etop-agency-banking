...
public class M1CardActivity_ViewBinding implements Unbinder {
  private M1CardActivity target;

  private View view7f0a00c5;

  @UiThread
  public M1CardActivity_ViewBinding(M1CardActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public M1CardActivity_ViewBinding(final M1CardActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    M1CardActivity target = this.target;
