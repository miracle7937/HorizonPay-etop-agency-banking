...
public class IcCardActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public IcCardActivity_ViewBinding(IcCardActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public IcCardActivity_ViewBinding(final IcCardActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    IcCardActivity target = this.target;
