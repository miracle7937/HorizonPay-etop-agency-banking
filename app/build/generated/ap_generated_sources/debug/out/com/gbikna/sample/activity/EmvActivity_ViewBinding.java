...
public class EmvActivity_ViewBinding implements Unbinder {
  private EmvActivity target;

  private View view7f0a00c5;

  @UiThread
  public EmvActivity_ViewBinding(EmvActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public EmvActivity_ViewBinding(final EmvActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    EmvActivity target = this.target;
