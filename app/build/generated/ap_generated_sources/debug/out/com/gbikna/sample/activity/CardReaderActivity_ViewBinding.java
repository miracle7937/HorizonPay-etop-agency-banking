...
public class CardReaderActivity_ViewBinding implements Unbinder {
  private CardReaderActivity target;

  private View view7f0a00c5;

  @UiThread
  public CardReaderActivity_ViewBinding(CardReaderActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public CardReaderActivity_ViewBinding(final CardReaderActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    CardReaderActivity target = this.target;
